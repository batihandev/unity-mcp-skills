...
reports, turning a red report into a copy of a later green one. The measurements and the three
failed repairs are in
...
- Unity serializes the Test Runner — do not start a second run while another is active. Wait for the
  first report to appear *and* for its mtime to stop changing.
