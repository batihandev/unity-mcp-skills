...
internal class CommandScript : IRunCommand
{
    ...
    {
        string requiredRootsJson = null;   // e.g. "[\"Managers\",\"World\"]"
        string requiredTagsJson = null;    // e.g. "[\"Player\"]"
        string requiredLayersJson = null;  // e.g. "[\"UI\"]"
        bool requireEventSystemForUi = true;
        ...
        {
            result.SetValue(new { success = false, error = $"Invalid contract JSON array: {ex.Message}" });
            return;
        }
